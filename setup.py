...
setup(
    ...
    package_data={},
    install_requires=[
        'comet-ml==3.*,>=3.1.10,>=3.1.2', 'dash==1.*,>=1.12.0',
        'dask==2.*,>=2.5.0', 'distributed==2.*,>=2.5.0', 'everett==1.*,>=1.0.2',
        'fsspec==0.*,>=0.6.0', 'modin==0.*,>=0.7.2', 'pandas==1.0.1',
        'pdoc3==0.*,>=0.7.2', 'pillow==7.*,>=7.0.0', 'plotly==4.*,>=4.8.0',
        'portray==1.*,>=1.3.0', 'ray', 'sklearn==0.*,>=0.0.0',
        'sphinx==2.*,>=2.2.0', 'torch==1.*,>=1.3.0', 'tqdm==4.*,>=4.43.0'
    ],
